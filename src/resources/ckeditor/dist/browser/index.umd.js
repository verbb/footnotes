(function (global, factory) {
    ...
    class InsertFootnoteCommand extends ckeditor5.Command {
        refresh() {
    ...
    class RemoveFootnoteCommand extends ckeditor5.Command {
        refresh() {
    ...
    class UpdateFootnoteTextCommand extends ckeditor5.Command {
        refresh() {
            const selection = this.editor.model.document.selection;
            const footnote = getSelectedFootnote(selection);
        ...
        init() {
            ...
            editor.conversion.for('editingDowncast').elementToElement({
                ...
                view: (modelItem, { writer })=>{
                    ...
                    return ckeditor5.toWidget(marker, writer, {
    ...
    class FootnotesActionsView extends ckeditor5.View {
        constructor(locale){
            super(locale);
            const t = this.t;
            const bind = this.bindTemplate;
            this.inputValue = '';
            this.saveButtonView = new ckeditor5.ButtonView(locale);
            this.removeButtonView = new ckeditor5.ButtonView(locale);
            this.cancelButtonView = new ckeditor5.ButtonView(locale);
            ...
            this.buttonsView = new ckeditor5.View(locale);
